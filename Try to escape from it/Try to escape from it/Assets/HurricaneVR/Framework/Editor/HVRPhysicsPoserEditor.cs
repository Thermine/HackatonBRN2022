...
namespace HurricaneVR.Editor
{
    ...
    public class HVRPhysicsPoserEditor : UnityEditor.Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            {
                PhysicsPoser.SetupCollision();
            };

            _root.Q<Button>("ResetButton").clickable.clicked += () =>
            {
                var position = PhysicsPoser.transform.localPosition;
                var rotation = PhysicsPoser.transform.localRotation;
                PhysicsPoser.Hand.Pose(PhysicsPoser.OpenPose);
                PhysicsPoser.transform.localPosition = position;
                PhysicsPoser.transform.localRotation = rotation;
