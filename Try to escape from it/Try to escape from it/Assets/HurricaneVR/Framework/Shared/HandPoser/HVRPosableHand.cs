...
namespace HurricaneVR.Framework.Shared.HandPoser
{
    public class HVRPosableHand : MonoBehaviour
    {
        ...
        public void Pose(HVRHandPoseData pose)
        {
        ...
        public HVRHandPoseData CreateHandPose(bool isWorld = false)
        {
            var data = new HVRHandPoseData
            {
                Position = isWorld ? transform.position : transform.localPosition,
                Rotation = isWorld ? transform.rotation : transform.localRotation,
            };
        ...
        public HVRHandPose CreateFullHandPose(MirrorAxis axis, bool isWorld = false)
        {
            var hand = CreateHandPose(isWorld);
        ...
        public HVRHandPoseData Mirror(MirrorAxis handMirrorAxis)
        {
            ...
            clone.Position = transform.localPosition;
            ...
            {
                forward = transform.parent.InverseTransformDirection(transform.forward);
                up = transform.parent.InverseTransformDirection(transform.up);
            }
            else
            {
